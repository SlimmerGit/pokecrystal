...
ENDM
	...
	npctrade 0, ABRA,       MACHOP,     "MUSCLE@@@@@", $37, $66, METAL_COAT,   37460, "MIKE@@@@@@@", TRADE_EITHER_GENDER
	npctrade 0, BELLSPROUT, ONIX,       "ROCKY@@@@@@", $96, $66, KINGS_ROCK, 48926, "KYLE@@@@@@@", TRADE_EITHER_GENDER
	npctrade 1, KRABBY,     VOLTORB,    "VOLTY@@@@@@", $98, $88, KINGS_ROCK, 29189, "TIM@@@@@@@@", TRADE_EITHER_GENDER
	npctrade 3, DRAGONAIR,  DODRIO,     "DORIS@@@@@@", $77, $66, SUN_STONE,   00283, "EMY@@@@@@@@", TRADE_FEMALE_ONLY
	npctrade 2, HAUNTER,    XATU,       "PAUL@@@@@@@", $96, $86, MOON_STONE, 15616, "CHRIS@@@@@@", TRADE_EITHER_GENDER
	npctrade 3, CHANSEY,    AERODACTYL, "AEROY@@@@@@", $96, $66, MOON_STONE,   26491, "KIM@@@@@@@@", TRADE_EITHER_GENDER
